...
# Wordmark is the brand — lowercase "statizen", matching the
# top-left wordmark in the live UI (components/overlays/Wordmark.tsx).
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="{W}" height="{H}" viewBox="0 0 {W} {H}">
  ...
  <text x="80" y="280" font-family="Archivo, Inter, system-ui, sans-serif"
    font-size="96" font-weight="500" fill="#ffffff"
